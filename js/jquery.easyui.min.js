...
bb.num=$("<input class=\"pagination-num\" type=\"hidden\" value=\"1\" size=\"2\" >").appendTo(tr).wrap("<td></td>");
...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:false,showRefresh:false,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_c6,_c7){
},onBeforeRefresh:function(_c8,_c9){
},onRefresh:function(_ca,_cb){
},onChangePageSize:function(_cc){
},beforePageText:"",afterPageText:"",displayMsg:"{total} Records",nav:{first:{iconCls:"pagination-first",handler:function(){
