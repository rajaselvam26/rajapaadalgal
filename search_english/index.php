...
<body><div style="width:1000px" align="center"><h2>Search</h2></div>
<form method="post">
<table width="903" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="163">Enter the key word</td>
    <td width="235">
  <input  name="fname"  />
</td>
...
exit;*/
$sel=mysql_query("select * from flim_english a,songs_english b where (a.id=b.fid) and (a.flimname like '$fname%' or a.actors like '$fname%' or a.prodbanner like '$fname%' or 
a.actresses like '$fname%' or a.fproducer like '$fname%'  or a.coartists like '$fname%' or a.fdirector like '$fname%'  or b.male_singer like '$fname%' 
or b.female_singer like '$fname%' or b.lyricist like '$fname%' or b.sname like '$fname%')");
