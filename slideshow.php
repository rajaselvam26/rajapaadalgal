...
<!-- <div class="iview-caption" id="cont"> -->
	<div class="container">
		<div id="iview">
			<div data-iview:image="photos/photo1.png" data-iview:transition="slice-top-fade,slice-right-fade">
<?php             
@$qry_tam="select * from songs_tamil inner join flim_tamil on songs_tamil.fid=flim_tamil.id where songs_tamil.fid='1' and songs_tamil.sid='1'";
...
?>      
<div class="iview-caption" data-x="55" data-y="250" style="margin-top:18px !important;">
<p style='line-height:25px;text-align:right;'>- <?php echo $row_tam[20];  ?> / <?php echo $row_tam[3]; ?> ,  <?php echo $row_tam[4]; ?> </p></div>
               
<div class="iview-caption" data-x="55" data-y="50" data-transition="wipeRight">
<?php 
$charset = 'UTF-8';
$length = 200;
$string = "$row_tam[6]";
...
{
$string = mb_substr($string, 25, $length, $charset) . '.....';
}
echo "<br><p style='line-height:25px'>";
echo $string; 
echo "</p>";
?>
</div>
...
<div data-iview:image="photos/photo2.png" data-iview:transition="zigzag-drop-top,zigzag-drop-bottom" data-iview:pausetime="3000">
<?php             
@$qry_tam="select * from songs_tamil inner join flim_tamil on songs_tamil.fid=flim_tamil.id where songs_tamil.fid='2' and songs_tamil.sid='1'";
...
if(mb_strlen($string, $charset) > $length) 
{
$string = mb_substr($string, 26, $length, $charset) . '.....';
}
echo "<br><p style='line-height:25px'>";
echo $string; 
echo "</p>";
...
<div data-iview:image="photos/photo3.png">
<?php             
@$qry_tam="select * from songs_tamil inner join flim_tamil on songs_tamil.fid=flim_tamil.id where songs_tamil.fid='2' and songs_tamil.sid='2'";
...
if(mb_strlen($string, $charset) > $length) 
{
$string = mb_substr($string, 33, $length, $charset) . '.....';
}
echo "<br><p style='line-height:25px'>";
echo $string; 
echo "</p>";
...
<div data-iview:image="photos/photo4.png">
<?php             
@$qry_tam="select * from songs_tamil inner join flim_tamil on songs_tamil.fid=flim_tamil.id where songs_tamil.fid='2' and songs_tamil.sid='3'";
...
if(mb_strlen($string, $charset) > $length) 
{
$string = mb_substr($string, 50, $length, $charset) . '.....';
}
echo "<br><p style='line-height:25px'>";
echo $string; 
echo "</p>";
