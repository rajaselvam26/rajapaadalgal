...
$sel1=mysql_query("select * from flim_tamil a,songs_tamil b where (a.id=b.fid) and (a.flimname like N'$fname%' or a.actors like N'$fname%' or a.prodbanner like N'$fname%' or 
a.actresses like N'$fname%' or a.fproducer like N'$fname%'  or a.coartists like N'$fname%' or a.fdirector like N'$fname%'  or b.male_singer like N'$fname%' 
or b.female_singer like N'$fname%' or b.lyricist like N'$fname%' or b.sname like N'$fname%')");
...
<li><iframe src="test/index-key.php" width="387" height="167" scrolling="yes" style="left: 884px;
    overflow: hidden;
    position: absolute;
    top: -14px; border:none;"></iframe></li>
</body>
</html>
