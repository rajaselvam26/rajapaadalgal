...
<textarea placeholder="Rajaapaadal" style="border-radius:5px;  height: 20px; width: 146px;" name="many_words_text" rows="1" cols="10" onfocus="javascript:print_many_words()" onkeyup="javascript:print_many_words()"></textarea>

</td>
<td class="converted_text">
<h5 style="padding-left:6px;margin-top: 1px;
    margin-bottom: 2px;">Copy and paste</h5>
<textarea  placeholder="ராஜாபாடல்" style="border-radius:5px; border: none; height: 20px; width: 146px;" id="contenteditable" name="converted_text" rows="1" cols="8" readonly="readonly"></textarea>
</td>
</tr>
</tbody></table>
</form>
